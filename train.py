...
parser.add_argument('--lr', type=float, default= 0.4, help='Applies to sgd and adagrad.')
...
parser.add_argument('--max_grad_norm', type=float, default=6.0, help='Gradient clipping.')
